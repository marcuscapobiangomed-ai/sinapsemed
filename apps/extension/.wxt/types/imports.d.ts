...
declare global {
  ...
  const FlashcardForm: typeof import('D:/MEU SAAS - DINDIN/apps/extension/components/FlashcardForm')['FlashcardForm']
  const InvalidMatchPattern: typeof import('wxt/sandbox')['InvalidMatchPattern']
  const LoginForm: typeof import('D:/MEU SAAS - DINDIN/apps/extension/components/LoginForm')['LoginForm']
  const MatchPattern: typeof import('wxt/sandbox')['MatchPattern']
  const MigrationError: typeof import('wxt/storage')['MigrationError']
  const ReviewSession: typeof import('D:/MEU SAAS - DINDIN/apps/extension/components/ReviewSession')['ReviewSession']
